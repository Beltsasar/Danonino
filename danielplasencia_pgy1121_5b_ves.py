# -*- coding: utf-8 -*-
"""DanielPlasencia_PGY1121_5b_Ves

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RQH-fj8I9WSBFXTvW_fzc525IILe6erH
...
while menuprincipal != 0:
    if menuprincipal == 1:
      while True:
        RutMi = int(input("Ingrese el rut sin digito verificador de la persona a mostrar\n"))
        DVMi = input("Ingrese el DV de la persona a mostrar\n")
        for m in range(len(Rut)-1,-1,-1):
          print("ingreso")
          if Rut[m] == str(RutMi) and DV[m] == str(DVMi):
            print("Rut(sin DV) \t\t DV \t\t Nombre \t\t Edad\t\t Pais de nacimiento \t\t Ciudad de nacimiento")
            print(Rut[m], "\t\t", DV[m], "\t\t", Nombre[m], "\t\t", Edad[m], "\t\t", PaisNac[m], "\t\t", CiuNac[m])
            break
        else:
